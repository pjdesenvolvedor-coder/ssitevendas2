...
export default function CustomerProfilePage() {
  ...
  useEffect(() => {
    ...
    // Define a URL de retorno baseada na origem da navegação
    const origin = sessionStorage.getItem("pj_contas_shop_origin") || "/";
    const ref = sessionStorage.getItem("pj_contas_ref");
    setBackUrl(ref ? `${origin}?ref=${ref}` : origin);
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="mt-12 flex justify-center">
              <Link href={backUrl}>
                <Button variant="outline" className="h-12 px-8 rounded-xl border-white/10 hover:bg-white/5 font-bold uppercase tracking-widest gap-3 text-[10px] transition-all">
